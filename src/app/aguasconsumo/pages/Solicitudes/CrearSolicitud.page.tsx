            ...
            if (aguacruda > 0 && descripcionsistema > 0 && analisisriesgo > 0) {
              if (rechazados <= 0) {
                ...
                const json: IConsesion<any> = {
                  ...
                  idPersona: idUsuario,
                  idTipodeSolicitud: objJson.idsolicitud === undefined ? 'B1BA9304-C16B-43F0-9AFA-E92D7B7F3DF9' : 'D33FBB9C-9F47-4015-BBE6-96FF43F0DDE4',
                  tipodeSolicitud: objJson.idsolicitud === undefined ? 'B1BA9304-C16B-43F0-9AFA-E92D7B7F3DF9' : 'D33FBB9C-9F47-4015-BBE6-96FF43F0DDE4',
                ...
                if (objJson.idsolicitud === undefined) {
                  ...
                  let formato = await api.getFormatoAguas('d790166c-27bd-4e25-b982-39b4a35e1d6f');


                  formato.cuerpo = formato.cuerpo.replace('~:~nro_radicado~:~', consecutivoventanilla.consecutivo);


                  await api.sendEmail({
                    to: dataSolicitud.persona.correoElectronico,
                    ...
                    <div className="col-lg-12 col-md-12 ml-4 col-sm-12 ">
                      ...
                      <div className={` ${current != 1 && 'd-none'} fadeInRight ${current == 1 && 'd-block'}`}>
                        ...
                        <div className="row mt-5 ml-2">
                          ...
                          <DatosAcueducto form={form} tipoSolicitud="primera-vez" obj={objJson} prop={addacueducto}
                                          habilitar={true}/>
                        </div>
                      ...
                      <div className={` ${current != 2 && 'd-none'} fadeInRight ${current == 2 && 'd-block'}`}>
                        <div className="row ml-2">
                          ...
                          <DatosAdicionales form={form} tipoSolicitud="primera-vez" obj={objJson} tipo={'validador'}
                                            prop={addinfo} habilitar={true}/>
                        </div>
