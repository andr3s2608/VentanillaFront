                ...
                <div className='row justify-content-center'>
                  <div className='col-lg-12 col-sm-12 col-md-12 justify-content-center text-center'>
                    ...
                    <p
                      ...
                      className='text-uppercase font-weight-bold'
                    >
                      En esta sección puede validar la autenticidad del documento emitido por esta entidad. Por favor digite el
                      código de verificación que viene anexo en el documento
                    </p>
                  </div>

                  <div className='col-lg-6 col-md-6 col-sm-12 '>
                    <Form.Item label='' name='nrodocumento' rules={[{ required: true }]}>
                      <Input
                        allowClear
