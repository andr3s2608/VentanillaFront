export const ChangeTheme = () => {
  ...
  var hovertable = document.getElementsByClassName('ant-table-cell');
  ...
  if (localStorage.getItem('isBlack') === 'true') {
    ...
    var n = hovertable.length;
    function changeColor(color) {
      for (var i = 0; i < n; i++) {
        hovertable[i].style.backgroundColor = color;
      }
    }
    for (var i = 0; i < n; i++) {
      hovertable[i].onmouseover = function () {
        changeColor('black');
      };
    }
